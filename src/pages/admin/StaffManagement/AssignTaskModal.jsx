...
const AssignTaskModal = ({ isOpen, onClose, staff, onConfirm }) => {
  ...
  const taskOptions = [
    ...
    { 
      value: 'COMPANY_REQUEST_AND_APPROVE_ARTICLE', 
      label: 'Company Request + Approve Article', 
      description: 'Xử lý yêu cầu công ty và phê duyệt bài viết',
      icon: BuildingOfficeIcon,
      color: 'bg-blue-50 border-blue-200 text-blue-700'
    },
    { 
      value: 'APPROVE_TOUR_BOOKING', 
      label: 'Approve Tour Booking', 
      description: 'Phê duyệt đặt tour',
      icon: MapPinIcon,
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-blue-50/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Giao nhiệm vụ</h2>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4 min-h-0">
          <p className="text-sm text-gray-600 mb-4">
            Chọn nhiệm vụ cho nhân viên này. Mỗi nhân viên chỉ có thể được gán một nhiệm vụ tại một thời điểm.
          </p>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <span className="text-xs text-gray-500 mt-1 block">
                  Nhân viên sẽ không có nhiệm vụ cụ thể
                </span>
              </div>
            </label>

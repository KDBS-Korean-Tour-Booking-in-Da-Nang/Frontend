  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Theo dõi hiệu suất kinh doanh và doanh thu</p>
      </div>
            ...
            {[
              ...
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-medium text-gray-900">{booking.amount.toLocaleString('vi-VN')} VND</p>
      ...
      {/* Popular Tours */}
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Tours phổ biến nhất</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={index} className="p-4 border border-gray-200 rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-1">{tour.bookings} đơn hàng</p>
